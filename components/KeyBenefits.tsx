  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute inset-x-0 top-0 h-36 bg-gradient-to-b from-black via-black to-transparent" />

        <div className="absolute left-[12%] top-[26%] h-[24rem] w-[24rem] rounded-full bg-[#ffc62a]/[0.075] blur-[170px]" />

        <div className="absolute bottom-[8%] right-[6%] h-[22rem] w-[22rem] rounded-full bg-[#ffc62a]/[0.04] blur-[180px]" />
      </div>
      ...
      <div className="section-shell relative z-10">
        <motion.div
          ...
          className="max-w-5xl"
        >
          <p className="ml-2 text-xs font-semibold uppercase tracking-[0.25em] text-[#ffc62a]">
              ...
              >
                ...
                <div className="relative flex items-start justify-between">
                  ...
                  <div className="flex h-11 w-11 items-center justify-center rounded-full border border-[#ffc62a]/25 bg-[#ffc62a]/[0.08] shadow-[0_0_24px_rgba(255,198,42,0.08)] transition duration-500 group-hover:border-[#ffc62a]/55 group-hover:bg-[#ffc62a]/[0.14] group-hover:shadow-[0_0_34px_rgba(255,198,42,0.18)]">
                    <Icon className="h-[18px] w-[18px] text-[#ffc62a] transition duration-500 group-hover:scale-110" />
                  </div>
                </div>
